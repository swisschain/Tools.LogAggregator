1. Copy `Service-LogAggregator` and `Service-LogAggregator-Worker` to the https://github.com/swisschain/kubernetes-swisschain/tree/master/Kubernetes/03.Pods/Tools. 
